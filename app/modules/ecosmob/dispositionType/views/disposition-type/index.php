...
/* @var $searchModel app\modules\ecosmob\dispositionType\models\DispositionTypeSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = DispositionTypeModule::t('dispositionType', 'disp_status');
$this->params['breadcrumbs'][] = $this->title;
$this->params['pageHead'] = $this->title;
?>


<?php Pjax::begin(['enablePushState' => false, 'id' => 'pjax-disposition-type', 'timeout' => 0]); ?>
<div class="row">
                                    ...
                                    <div class="card-content">
                                        ...
                                        <div class="dataTables_wrapper" id="page-length-option_wrapper">
                                            ...
                                            echo GridView::widget([
                                                'id' => 'disposition-type-grid-index', // TODO : Add Grid Widget ID
                                                'dataProvider' => $dataProvider,
                                                'layout' => Yii::$app->layoutHelper->get_layout_str('#disposition-type-search-form'),
                                                'showOnEmpty' => true,
                                                'pager' => [
