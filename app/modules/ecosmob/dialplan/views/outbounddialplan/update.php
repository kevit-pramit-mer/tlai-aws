...
$this->title = DialPlanModule::t('dp', 'update_outbound_dialplan') . $model->odpd_prefix_match_string;
$this->params['breadcrumbs'][] = ['label' => DialPlanModule::t('dp', 'outbound_dialplans'), 'url' => ['index']];
$this->params['breadcrumbs'][] = DialPlanModule::t('dp', 'update');
...
<div class="col-md-12 profile-contain">
    <div class="row">
        <div class="col-xl-9 col-md-7 col-xs-12">
            <div class="content">
                <div class="outbound-dial-plans-details-update">
