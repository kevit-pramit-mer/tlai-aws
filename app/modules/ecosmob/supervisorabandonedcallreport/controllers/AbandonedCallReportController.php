...
namespace app\modules\ecosmob\supervisorabandonedcallreport\controllers;

use app\components\CommonHelper;
use app\modules\ecosmob\queue\models\QueueMaster;
use app\modules\ecosmob\supervisorabandonedcallreport\models\QueueAbandonedCalls;
use app\modules\ecosmob\supervisorabandonedcallreport\models\QueueAbandonedCallsSearch;
use Yii;
        ...
        if (!empty($records)) {
            foreach ($records as $record) {
                ...
                foreach ($headers as $head) {
                    ...
                    if ($head == 'queue_name') {
                        $row[$head] = (!empty($record->queue_name) ? QueueMaster::getQueueName($record->queue_name) : '-');
                    }
