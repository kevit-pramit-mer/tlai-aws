...
$this->title = AgentsWiseReportModule::t('agentswisereport', 'agentsreport');
$this->params['breadcrumbs'][] = $this->title;
$this->params['pageHead'] = $this->title;
?>

<?php Pjax::begin(['id' => 'agent-wise-report-index', 'timeout' => 0, 'enablePushState' => false]); ?>
                                        ...
                                        <div class="dataTables_wrapper" id="page-length-option_wrapper">
                                            <div class="card-header d-flex align-items-center justify-content-between w-100">
                                                ...
                                                <div class="card-header-btns">
                                                    <?php /*= Html::a(AgentsWiseReportModule::t('agentswisereport', 'export'), ['/agentswisereport/agents-call-report/export'], [
                                                        'id' => 'hov view_link',
                                                        'data-pjax' => '0',
                                                    ...
                                                    <button id="export-button" class="exportbutton lead_group btn waves-effect waves-light darken-1 breadcrumbs-btn right">
                                                        <?= AgentsWiseReportModule::t('agentswisereport', 'export') ?>
                                                    </button>
                                                </div>
                                            </div>
                                            <?php try {
                                                echo GridView::widget([
                                                    ...
                                                    'columns' => [
                                                        ...
                                                        [
                                                            ...
                                                            'contentOptions' => ['class' => 'text-center'],
                                                            'value' => function ($model) {
                                                                return (!empty($model->start_time) ? date('Y-m-d', strtotime(CommonHelper::tsToDt($model->start_time))) : '-');
                                                            }
                                                        ],
                                                        [
                                                            ...
                                                            'enableSorting' => True,
                                                            'value' => function ($model) {
                                                                return (!empty($model->start_time) ? date('H:i:s', strtotime(CommonHelper::tsToDt($model->start_time))) : '-');
                                                            }
                                                        ],
                                                        [
                                                            'attribute' => 'ans_time',
                                                        ...
                                                        [
                                                            ...
                                                            'enableSorting' => True,
                                                            'value' => function ($model) {
                                                                return (!empty($model->end_time) ? date('H:i:s', strtotime(CommonHelper::tsToDt($model->end_time))) : '-');
                                                            }
                                                        ],
                                                        [
                                                        ...
                                                        [
                                                            'attribute' => 'id',
                                                            'label' => AgentsWiseReportModule::t('agentswisereport', 'action'),
                                                            'format' => 'raw',
                                                            'headerOptions' => ['class' => 'text-center'],
                                                            'contentOptions' => ['class' => 'text-center'],
                                                            'enableSorting' => True,
...
<script>
    $(document).ready(function () {
        $('.agentswisereport-link').addClass('active-class');
...
$this->registerJs("
    $(document).on('click', '.exportbutton', function () {
        ...
        if (count <= 0) {
            ...
            window.location.href = '".Url::to(['/agentswisereport/agents-call-report/export'])."';
        }
    });");
?>
