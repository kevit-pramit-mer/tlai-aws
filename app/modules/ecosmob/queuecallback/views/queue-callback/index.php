...
/* @var $searchModel app\modules\ecosmob\queuecallback\models\QueueCallbackSearch */
...
?>
<?php Pjax::begin(['id' => 'queue-callback-index', 'timeout' => 0, 'enablePushState' => false]); ?>
<div class="row">
                                    ...
                                    <div class="card-content">
                                        <div class="card-header d-flex align-items-center justify-content-between w-100">
                                            ...
                                            <div class="card-header-btns">
                                                <?= Html::a(Yii::t('app', 'export'), ['/queuecallback/queue-callback/export'], [
                                                    'id' => 'hov view_link',
                                                    'data-pjax' => '0',
