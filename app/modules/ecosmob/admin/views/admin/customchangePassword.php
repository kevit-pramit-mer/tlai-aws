...
<?php if (Yii::$app->session->hasFlash('success')) : ?>
    ...
    <div class="col s4 right alert set-alert-theme" role="alert">
...
<?php if (Yii::$app->session->hasFlash('error')) : ?>
    ...
    <div class="col s4 right alert fixed-alert" role="alert">
        <div class="card-alert card gradient-45deg-red-pink mt-1" style="max-height: 55px">
            <div class="row">
                <div class="col s10">
                    <div class="card-content white-text">
                        <p>
                ...
                <div class="col s2">
                    <button type="button" class="mt-2 close white-text" data-dismiss="alert"
                            aria-label="Close">
                        <span aria-hidden="true">×</span>
                    </button>
                </div>
        ...
        <div class="col s12">
            <div class="container">
                ...
                <div class="admin-change-password" id="admin-change-password">
                    <?= $this->render('form/custom_changePassword',
                        [
                            'model' => $model,
                        ]) ?>
                </div>
