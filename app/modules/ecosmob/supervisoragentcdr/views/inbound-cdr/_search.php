...
/* @var $model app\modules\ecosmob\cdr\models\InboundCdrSearch */
                    ...
                    <div class="card-header card-custom">
                        <a class="card-title" data-toggle="collapse" data-parent="#accordion" href="#collapseOne">
                            <h6 class="mb-0"><span class="fa fa-search"></span>
                                <?= SupervisorAgentCdrModule::t('cdr', 'search') ?>
                            </h6></a>
                    </div>
                        ...
                        <div class="card-block">
                            <div class="row">
                                <div class="form-group" style="display: none">
                                    <?= $form->field($model, 'main_uuid', ['options' => ['class' => 'col-xs-12 col-md-6']])->textInput(['maxlength' => true, 'placeholder' => CdrModule::t('cdr', "main_uuid")]); ?>
                                </div>
                            ...
                            <div class="row">
                                <div class="form-group">
                                    ...
                                    <?= $form->field(
                                        ...
                                        ['prompt' => SupervisorAgentCdrModule::t('cdr', 'all')]
                                    ); ?>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="form-group col-sm-offset-5 col-md-offset-5 col-xs-offset-2">
                                    <?= Html::submitButton(SupervisorAgentCdrModule::t('cdr', 'search'), ['class' =>
                                        'btn btn-primary btn-round-left']) ?>
                                    <?= Html::a(SupervisorAgentCdrModule::t('cdr', 'reset'), ['index', 'page' =>
