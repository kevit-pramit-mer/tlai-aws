    ...
    <div class="col s12">
            ...
            <div class="card-content">
                <div class="admin-master-form" id="admin-master-form">
                    ...
                    <div class="row">
                        <div class="col s12 m6">
                            <div class="input-field">
                                <?= $form->field($model, 'adm_username', ['options' => ['class' => '']])->textInput(['maxlength'=>true, 'placeholder' => ($model->getAttributeLabel('adm_username')), 'autocomplete' => 'off'])->label($model->getAttributeLabel('adm_username')); ?>
                            </div>
                        </div>
                        <div class="col s12 m6">
                            <div class="input-field">
                        ...
                        <div class="col s12 m6 web-password">
                            ...
                            ?>
                                <?= $form->field($model, 'adm_password'
                                    ...
                                    ->label(SupervisorModule::t('supervisor', 'password')); ?>
                        ...
                        <div class="col s12 m6">
                            <div class="input-field">
                                <div class="select-wrapper">
                                    <?= $form->field($model, 'adm_timezone_id', ['options' => ['class' => 'input-field']])->dropDownList(Timezone::getTimezone(), ['prompt' => SupervisorModule::t('supervisor', 'select_timezone')])->label(SupervisorModule::t('supervisor', 'timezone')); ?>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="input-field">
                                <div class="select-wrapper">
                                    ...
                                    ([1 => Yii::t('app', 'active'), 0 => Yii::t('app', 'inactive')],
                                        ['prompt' => SupervisorModule::t('supervisor',
                                            'select_status')])->label(SupervisorModule::t('supervisor', 'status')); ?>
                                </div>
                            </div>
                        </div>
                        <div class="col s12 m6">
                            <div class="input-field">
                                <div class="select-wrapper">
                                    <?= $form->field($model, 'adm_mapped_extension', ['options' => ['class' => 'input-field']])->dropDownList($ext, ['prompt' => SupervisorModule::t('supervisor', 'select_extension')])
                                        ->label(SupervisorModule::t('supervisor', 'extension')) ?>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="row mt-2">
            <div class="col s12 pb-3 d-flex align-items-center gap-10">
                <?= Html::a(SupervisorModule::t('supervisor', 'cancel'), ['index', 'page' => Yii::$app->session->get('page')],
                    ['class' => 'btn waves-effect waves-light bg-gray-200']) ?>
                <?= Html::submitButton($model->isNewRecord ? SupervisorModule::t('supervisor', 'create') : SupervisorModule::t('supervisor', 'update'), ['class'=>$model->isNewRecord ? 'btn waves-effect waves-light amber darken-4' :
