            ...
            <div class="container">
                <div id="card-stats">
                    <div class="row mb-2">
                        ...
                        <div class="col s12 m7 right-align-sm">
                            ...
                            <?php /*= Html::a(SupervisorModule::t('supervisor', 'agents'), ['/supervisor/supervisor/login-link/'], ['class' => 'btn btn-basic Agents']) */?>
                        </div>
                    ...
                    <div class="row">
                            ...
                            <div class="card animate fadeLeft">
                                <div class="card-content">
                                    <div class="card-stats-title">
                                        <p class="card-counter-title"><?php echo SupervisorModule::t('supervisor', 'live_q_call'); ?></p>
                                        <h4 class="card-stats-number m-0 activeCallsCount">0</h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col s12 m6 l4">
                            <div class="card animate fadeLeft">
                                <div class="card-content">
                                    <div class="card-stats-title">
                                        <p class="card-counter-title"><?php echo SupervisorModule::t('supervisor', 'live_session'); ?>
                                            - <?= SupervisorModule::t('supervisor', 'agents_logged_in') ?></p>
                                        <h4 class="card-stats-number m-0 agent_count">0</h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col s12 m6 l4">
                            <div class="card animate fadeLeft">
                                <div class="card-content">
                                    <div class="card-stats-title">
                                        <p class="card-counter-title"><?php echo SupervisorModule::t('supervisor', 'live_session'); ?>
                                            - <?= SupervisorModule::t('supervisor', 'superwisor_logged_in') ?></p>
                                        <h4 class="card-stats-number m-0 supervisor_count">0</h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col s12 m6 l4">
                            <div class="card animate fadeLeft">
                                <div class="card-content">
                                    <div class="card-stats-title">
                                        <p class="card-counter-title"><?php echo SupervisorModule::t('supervisor', 'agent_call_sts'); ?>
                                            - <?= SupervisorModule::t('supervisor', 'in_break') ?></p>
                                        <h4 class="card-stats-number m-0 cmp_type">0</h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col s12 m6 l4">
                            <div class="card animate fadeLeft">
                                <div class="card-content">
                                    <div class="card-stats-title">
                                        <p class="card-counter-title"><?php echo SupervisorModule::t('supervisor', 'agent_call_sts'); ?>
                                            - <?= SupervisorModule::t('supervisor', 'agents_available') ?></p>
                                        <h4 class="card-stats-number m-0 available">0</h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col s12 m6 l4">
                            <div class="card animate fadeLeft">
                                <div class="card-content">
                                    <div class="card-stats-title">
                                        <p class="card-counter-title"><?= SupervisorModule::t('supervisor', 'break_time') ?></p>
                                        <h4 class="card-stats-number m-0 break_time">00:00:00</h4>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<script type="text/javascript">
        ...
        if ($(this).find(':selected').val() == '') {
            ...
            $.ajax({
                ...
                success: function (result) {
                    ...
                    $(".cmp_type").text(final_data.breakCount);
                    $(".available").text(final_data.agentsAvailableList);
                    $(".total").text(final_data.total);
                    $(".agent_count").text(final_data.agentCount);
                    console.log('supervisor_count', final_data.supervisorCount);
                    $(".supervisor_count").text(final_data.supervisorCount);
                    if(final_data.inOut == 'in'){
                        $('.In').show();
                        $('.Out').hide();
                    }else{
                        $('.In').hide();
    ...
    function activeCallsList() {
        ...
        $.ajax({
            url: baseURL + "index.php?r=supervisor/supervisor/active-call-list" + temp_camp,
            type: 'GET',
            success: function (result) {
    ...
    function breakTime(){
        if ($('#breakreasonmapping-camp_id').find(':selected').val() != "") {
            var cmp_type = $('#breakreasonmapping-camp_id').find(':selected').val();
            $.ajax({
                type: 'POST',
                data: "camp_type=" + cmp_type,
                url: baseURL + "index.php?r=supervisor/supervisor/break-time",
                success: function (result) {
                    var final_data = $.parseJSON(result);
                    if(final_data){
                        $(".break_time").text(final_data);
                    }
                }
            });
        }else{
            $(".break_time").text("00:00:00");
        }
    }
