...
/* @var $model app\modules\ecosmob\faxdetailsreport\models\InboundCdrSearch */
                    ...
                    <div class="card-header card-custom">
                        <a class="card-title" data-toggle="collapse" data-parent="#accordion" href="#collapseOne">
                            <h6 class="mb-0"><span class="fa fa-search"></span>
                                <?= FaxDetailsReportModule::t('cdr', 'search') ?>
                            </h6></a>
                    </div>
                        ...
                        <div class="card-block">
                            <div class="row">
                                <div class="form-group" style="display: none">
                                    <?= $form->field($model, 'main_uuid', ['options' => ['class' => 'col-xs-12 col-md-6']])->textInput(['maxlength' => true, 'placeholder' => FaxDetailsReportModule::t('cdr', "main_uuid")]); ?>
                                </div>
                                <div class="form-group">
                                    <?= $form->field($model, 'outpluse_dialed_number', ['options' => ['class' => 'col-xs-12 col-md-6']])->textInput(['maxlength' => true, 'placeholder' => FaxDetailsReportModule::t('cdr', "outpluse_dialed_number")]); ?>
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group">
                            ...
                            <div class="row">
                                <div class="form-group">
                                    ...
                                    <?= $form->field(
                                        ...
                                        ['prompt' => FaxDetailsReportModule::t('cdr', "all")]
                                    ); ?>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="form-group col-sm-offset-5 col-md-offset-5 col-xs-offset-2">
                                    <?= Html::submitButton(FaxDetailsReportModule::t('cdr', 'search'), ['class' =>
                                        'btn btn-primary btn-round-left']) ?>
                                    <?= Html::a(FaxDetailsReportModule::t('cdr', 'reset'), ['index', 'page' =>
