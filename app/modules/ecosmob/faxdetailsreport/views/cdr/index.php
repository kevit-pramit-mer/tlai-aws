...
/* @var $searchModel app\modules\ecosmob\faxdetailsreport\models\CdrSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = FaxDetailsReportModule::t('cdr', 'cdr_reports');
...
?>
<?php Pjax::begin(['id' => 'fax-detail-report-index', 'timeout' => 0, 'enablePushState' => false]); ?>
<div class="row">
                                        ...
                                        <div class="dataTables_wrapper" id="page-length-option_wrapper">
                                            <div class="card-header d-flex align-items-center justify-content-between w-100">
                                                ...
                                                <div class="card-header-btns">
                                                   <!-- --><?php /*= Html::a(FaxDetailsReportModule::t('cdr', 'export'), ['/faxdetailsreport/cdr/export'], [
                                                        'id' => 'hov view_link',
                                                        'data-pjax' => '0',
                                                    ...
                                                    <button id="export-button" class="exportbutton lead_group btn waves-effect waves-light darken-1 breadcrumbs-btn right">
                                                        <?= FaxDetailsReportModule::t('cdr', 'Export') ?>
                                                    </button>
                                                </div>
                                            </div>
                                            <?php try {
    ...
    <div class="modal-content">
        ...
        <div class="modal-footer">
            ...
            <button type="button" class="btn btn-primary common_delete" data-dismiss="modal" aria-hidden="true"
                    onclick="commonDownload('single')"><?= FaxDetailsReportModule::t('cdr', 'ok') ?>
            </button>
        </div>
    </div>
...
<script>
    $(document).ready(function () {
        $('.fax-report').addClass("active");
        $('.fax-child').removeClass("active");
...
$this->registerJs("
    $(document).on('click', '.exportbutton', function () {
        ...
        if (count <= 0) {
            ...
            window.location.href = '".Url::to(['/faxdetailsreport/cdr/export'])."';
        }
    });");
?>
