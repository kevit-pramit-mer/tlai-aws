...
$this->title = LeadgroupModule::t('leadgroup', 'update_lead_grp') . $model->ld_group_name;
$this->params['breadcrumbs'][] = ['label' => LeadgroupModule::t('leadgroup', 'lead_grp'), 'url' => ['index']];
$this->params['breadcrumbs'][] = LeadgroupModule::t('leadgroup', 'update');
...
<div class="col-md-12 profile-contain">
    <div class="row">
        <div class="col-xl-9 col-md-7 col-xs-12">
            <div class="content">
                <div class="leadgroup-master-update">
