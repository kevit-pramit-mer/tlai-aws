...
/* @var $model app\modules\ecosmob\blacklistnumberdetails\models\InboundCdrSearch */
                    ...
                    <div class="card-header card-custom">
                        <a class="card-title" data-toggle="collapse" data-parent="#accordion" href="#collapseOne">
                            <h6 class="mb-0"><span class="fa fa-search"></span>
                                <?= BlacklistNumberDetailsModule::t('cdr', 'search') ?>
                            </h6></a>
                    </div>
                        ...
                        <div class="card-block">
                            <div class="row">
                                <div class="form-group" style="display: none">
                                    <?= $form->field($model, 'main_uuid', ['options' => ['class' => 'col-xs-12 col-md-6 input-field']])->textInput(['maxlength' => true, 'placeholder' => BlacklistNumberDetailsModule::t('cdr', "main_uuid")]); ?>
                                </div>
                                <div class="form-group">
                                    <?= $form->field($model, 'outpluse_dialed_number', ['options' => ['class' => 'col-xs-12 col-md-6 input-field']])->textInput(['maxlength' => true, 'placeholder' => BlacklistNumberDetailsModule::t('cdr', "outpluse_dialed_number")]); ?>
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group">
                                    <?= $form->field($model, 'start_epoch',
                                        ['options' => ['class' => 'col-xs-12 col-md-6 input-field']])->textInput(['class' => 'form-control drp', 'autocomplete' => 'off', 'placeholder' => date('Y-m-d 00:00:00') . " - " . date('Y-m-d 23:59:59')]); ?>

                                    <?= $form->field($model, 'answer_epoch',
                                        ['options' => ['class' => 'col-xs-12 col-md-6 input-field']])->textInput(['class' => 'form-control drp', 'autocomplete' => 'off', 'placeholder' => 'Answer Time']); ?>
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group">
                                    <?= $form->field($model, 'end_epoch',
                                        ['options' => ['class' => 'col-xs-12 col-md-6 input-field']])->textInput(['class' => 'form-control drp', 'autocomplete' => 'off', 'placeholder' => 'End Time']); ?>

                                    <?= $form->field(
                                        $model,
                                        'callstatus',
                                        ['options' => ['class' => 'col-xs-12 col-md-6 input-field']]
                                    )->dropDownList(
                                        [
                                            'failed' => 'failed',
                                            'completed' => 'completed',
                            ...
                            <div class="row">
                                <div class="form-group col-sm-offset-5 col-md-offset-5 col-xs-offset-2">
                                    <?= Html::submitButton(BlacklistNumberDetailsModule::t('cdr', 'search'), ['class' =>
                                        'btn btn-primary btn-round-left']) ?>
                                    <?= Html::a(BlacklistNumberDetailsModule::t('cdr', 'reset'), ['index', 'page' =>
