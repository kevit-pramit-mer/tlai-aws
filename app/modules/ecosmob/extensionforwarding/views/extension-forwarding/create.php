...
$this->title = ExtensionForwardingModule::t('extensionforwarding', 'create_ext_forw');
$this->params['breadcrumbs'][] = ['label' => ExtensionForwardingModule::t('extensionforwarding', 'ext_forw'), 'url' => ['index']];
                            ...
                            <div class="col s12">
                                ...
                                <div class="col-md-12 profile-contain">
                                    <div class="row">
                                        <div class="col-xl-9 col-md-7 col-xs-12">
                                            <div class="content">
                                                <div class="extension-forwarding-create">
