...
/* @var $model \app\modules\ecosmob\ipprovisioning\models\DeviceTemplatesSearch */
...
<ul class="collapsible collapsible-accordion" data-collapsible="accordion" >
    <li>
        ...
        <div class="collapsible-body">
            <div id="input-fields">
                <div class="device-templates-search"
                     id="device-templates-search">
                    <?php $form = ActiveForm::begin([
                        'id' => 'device-templates-search-form',
                        'action' => ['index'],
                        'method' => 'get',
                        'options' => [
                            'data-pjax' => 1,
