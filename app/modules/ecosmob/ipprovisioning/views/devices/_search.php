...
/* @var $model \app\modules\ecosmob\ipprovisioning\models\DevicesSearch */
                ...
                <div class="devices-search"
                    ...
                    <div class="row">
                        <div class="col s12 m6">
                            <?= $form->field($model, 'device_name')->textInput(['maxlength' => 50, 'placeholder' => ($model->getAttributeLabel('device_name'))]) ?>
                        </div>
