...
namespace app\modules\ecosmob\agentscallreport\controllers;

use app\components\CommonHelper;
use app\modules\ecosmob\agentscallreport\models\AgentsCallReport;
use app\modules\ecosmob\agentscallreport\models\AgentsCallReportSearch;
...
class AgentsCallReportController extends Controller
{
    ...
    public function actionIndex()
    {
        ...
        Yii::$app->session->set('agentscall', $dataProvider->query);
    ...
    public function actionExport()
    {
        ...
        $model = new AgentsCallReport();
        $query = Yii::$app->session->get('agentscall');
