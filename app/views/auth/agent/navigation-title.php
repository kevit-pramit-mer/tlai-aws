...
if (in_array('/cdr/cdr/index', $permissions) ||
   ...
   /* in_array('/queuecallback/queue-callback/index', $permissions) ||*/
    ...
    <?php if (in_array('/blacklistnumberdetails/cdr/index', $permissions)) { ?>
        <li class="bold">
            <a title="<?= Yii::t('app', 'blacklist_number') ?>" class="waves-effect waves-cyan blacklist-cdr" data-href="blacklistnumberdetails"
   ...
   <!-- <?php /*if (in_array('/queuecallback/queue-callback/index', $permissions)) { */?>
    ...
    <?php if (in_array('/abandonedcallreport/abandoned-call-report/index', $permissions)) { ?>
        <li class="bold">
            <a title="<?= Yii::t('app', 'abandonedcallreport') ?>" class="waves-effect waves-cyan" data-href="abandoned-call-report"
    ...
    <?php if (in_array('/faxdetailsreport/cdr/index', $permissions)) { ?>
        <li class="bold">
            <a title="<?= Yii::t('app', 'fax_detail_report') ?>" class="waves-effect waves-cyan fax-report" data-href="faxdetailsreport"
    ...
    <?php if (in_array('/fraudcalldetectionreport/cdr/index', $permissions)) { ?>
        <li class="bold">
            <a title="<?= Yii::t('app', 'detection_report') ?>" class="waves-effect waves-cyan fraud-report" data-href="fraudcalldetectionreport"
    ...
    <?php if (in_array('/queuewisereport/queue-wise-report/index', $permissions)) { ?>
        <li class="bold">
            <a title="<?= Yii::t('app', 'queuewise_report') ?>" class="waves-effect waves-cyan" data-href="queuewisereport"
    ...
    <?php if (in_array('/agentswisereport/agents-call-report/index', $permissions)) { ?>
        <li class="bold">
            <a title="<?= Yii::t('app', 'agents_wise_report') ?>" class="waves-effect waves-cyan agentswisereport-link" data-href="agentswisereport"
    ...
    <?php if (in_array('/extensionsummaryreport/cdr/index', $permissions)) { ?>
        <li class="bold">
            <a title="<?= Yii::t('app', 'extension_summary_report') ?>" class="waves-effect waves-cyan extension-report" data-href="extensionsummaryreport"
